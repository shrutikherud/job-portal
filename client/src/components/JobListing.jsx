    ...
    <div className="container 2xl:px-20 mx-auto flex flex-col lg:flex-row mx-lg:space-y-8 py-8">
      ...
      <div className="w-full lg:w-1/4 bg-white px-4">
          ...
          (searchFilter.title !== "" || searchFilter.location !== "") && (
            <>
              ...
              <div className="mb-4 text-gray-600">
                {searchFilter.title && (
                  <span className="inline-flex items-center gap-2.5 bg-red-100 text-gray-700 border border-red-200 px-4 py-1 rounded-md">
                    {searchFilter.title}
                    <img
                      onClick={(e) =>
                ...
                {searchFilter.location && (
                  <span className="ml-3 inline-flex items-center gap-2.5 bg-blue-100 text-blue-700 border border-blue-200 px-4 py-1 rounded-md ">
                    {searchFilter.location}
                    <img
                      onClick={(e) =>
        ...
        <button
          ...
          className="px-6 py-1.5 border border-gray-400 rounded lg:hidden cursor-pointer"
        >
